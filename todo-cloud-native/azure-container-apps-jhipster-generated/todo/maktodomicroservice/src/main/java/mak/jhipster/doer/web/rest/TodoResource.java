...
import mak.jhipster.doer.service.TodoService;
...
public class TodoResource {
    ...
    private static final String ENTITY_NAME = "maktodomicroserviceTodo";
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<TodoDTO>> getAllTodos(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
