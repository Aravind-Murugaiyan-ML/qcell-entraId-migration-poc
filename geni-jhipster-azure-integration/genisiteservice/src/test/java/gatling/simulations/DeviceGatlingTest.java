        ...
        .on(
            exec(
                http("Get all devices")
                    .get("/services/genisiteservice/api/devices")
                ...
                .exec(
                    http("Create new device")
                        .post("/services/genisiteservice/api/devices")
                        .headers(headers_http_authenticated)
                        .body(
                            StringBody(
                                "{" +
                ...
                .repeat(5)
                .on(
                    exec(http("Get created device").get("/services/genisiteservice${new_device_url}").headers(headers_http_authenticated))
                        .pause(10)
                )
                .exec(
                    http("Delete created device").delete("/services/genisiteservice${new_device_url}").headers(headers_http_authenticated)
                )
                .pause(10)
        );
