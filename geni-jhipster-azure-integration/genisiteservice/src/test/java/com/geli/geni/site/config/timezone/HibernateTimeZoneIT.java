package com.geli.geni.site.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.geli.geni.site.IntegrationTest;
import com.geli.geni.site.repository.timezone.DateTimeWrapper;
import com.geli.geni.site.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM geni_date_time_wrapper where id=%d", fieldName, id);
    }
