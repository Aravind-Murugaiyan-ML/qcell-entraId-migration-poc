package com.geli.geni.site.service;

import com.geli.geni.site.config.Constants;
import com.geli.geni.site.domain.Authority;
import com.geli.geni.site.domain.Userfalse;
import com.geli.geni.site.repository.AuthorityRepository;
import com.geli.geni.site.repository.UserRepository;
import com.geli.geni.site.security.SecurityUtils;
...
public class UserService {
    ...
    @Transactional(readOnly = true)
    public Optional<Userfalse> getUserWithAuthoritiesByLogin(String login) {
    ...
    private Userfalse syncUserWithIdP(Map<String, Object> details, Userfalse user) {
        ...
        Optional<Userfalse> existingUser = userRepository.findOneByLogin(user.getLogin());
    ...
    private void clearUserCaches(Userfalse user) {
