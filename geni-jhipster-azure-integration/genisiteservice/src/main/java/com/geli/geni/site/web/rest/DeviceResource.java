...
import com.geli.geni.site.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.geli.geni.site.domain.Devicefalse}.
 */
@RestController
...
public class DeviceResource {
    ...
    private static final String ENTITY_NAME = "genisiteserviceDevice";
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<DeviceDTO>> getAllDevices(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
