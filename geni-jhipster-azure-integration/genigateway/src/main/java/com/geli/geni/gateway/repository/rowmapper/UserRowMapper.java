package com.geli.geni.gateway.repository.rowmapper;
...
/**
 * Converter between {@link Row} to {@link Userfalse}, with proper type conversions.
 */
@Service
public class UserRowMapper implements BiFunction<Row, String, Userfalse> {
     ...
     * @return the {@link Userfalse} stored in the database.
     */
    @Override
    public Userfalse apply(Row row, String prefix) {
        Userfalse entity = new Userfalse();
