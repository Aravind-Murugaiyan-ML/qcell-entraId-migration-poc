...
import com.geli.geni.gateway.security.SecurityUtils;
...
public class UserService {
    ...
    @Transactional
    public Mono<Userfalse> saveUser(Userfalse user) {
        return saveUser(user, false);
    }

    @Transactional
    public Mono<Userfalse> saveUser(Userfalse user, boolean forceCreate) {
        return SecurityUtils
            .getCurrentUserLogin()
    ...
    @Transactional(readOnly = true)
    public Mono<Userfalse> getUserWithAuthoritiesByLogin(String login) {
    ...
    private Mono<Userfalse> syncUserWithIdP(Map<String, Object> details, Userfalse user) {
    ...
    public Mono<AdminUserDTO> getUserFromAuthentication(AbstractAuthenticationToken authToken) {
        ...
        Userfalse user = getUser(attributes);
        user.setAuthorities(
            authToken
                .getAuthorities()
                .stream()
    ...
    private static Userfalse getUser(Map<String, Object> details) {
